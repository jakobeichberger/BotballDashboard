...
export default function ScanReviewPage() {
  ...
  const retry = useMutation({
    ...
    onError: (e: any) => setRetryError(typeof e?.response?.data?.detail === "string" ? e.response.data.detail : t("common:actionFailed")),
  });

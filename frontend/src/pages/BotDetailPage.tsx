...
export default function BotDetailPage() {
  ...
  if (isError || !bot) {
    return (
      <div className="p-6">
        <EventLink to="/bots" className="btn-secondary text-sm mb-6"><ArrowLeft className="w-4 h-4" /> Zurück zur Galerie</EventLink>
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <EventLink to="/bots" className="btn-secondary text-sm"><ArrowLeft className="w-4 h-4" /> Zurück zur Galerie</EventLink>
        {canManage && !editing && (

  ...
  return (
    <div className="p-6">
      <div className="flex flex-wrap items-center justify-between gap-3 mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="page-title flex items-center gap-2">
            <Plane className="h-7 w-7 shrink-0 text-akzent" />
            {t("aerial.title")}
          </h1>
        </div>
        <button
      ...
      {saveMutation.isSuccess && (
        <div className="mb-4 px-4 py-2 bg-success/[0.07] text-success rounded-lg text-sm">{t("profile:saved")}</div>
      )}
        ...
        <table className="w-full text-sm">
          <thead className="bg-flaeche-2">
            <tr>
              ...
              {[1, 2, 3, 4].map((n) => (
                <th key={n} className="px-4 py-3 text-center font-semibold">

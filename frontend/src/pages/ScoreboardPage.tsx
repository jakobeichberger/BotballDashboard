        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 dark:bg-gray-800">
            <tr>
              <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">#</th>
              <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">{t("scouting.team")}</th>
              <th className="px-4 py-3 text-left font-medium text-gray-600 dark:text-gray-400">{t("aerial.category")}</th>
              {Array.from({ length: runColumns }, (_, i) => (
                <th key={i} className="px-4 py-3 text-right font-medium text-gray-600 dark:text-gray-400">{t("aerial.run", { number: i + 1 })}</th>
              ))}
          ...
          <tbody className="divide-y dark:divide-gray-800">
            ...
            {data?.length === 0 && (
              <tr>
                <td colSpan={runColumns + 4} className="px-4 py-8 text-center text-gray-400">{t("scoreboard.noAerial")}</td>
              </tr>
            )}
          </tbody>
        </table>

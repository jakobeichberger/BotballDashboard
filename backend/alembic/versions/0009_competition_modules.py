...
def upgrade() -> None:
    ...
    op.add_column(
        "seasons", sa.Column("use_seeding", sa.Boolean(), nullable=False, server_default="true")
    )
    op.add_column(
        "seasons",
        sa.Column("use_double_elimination", sa.Boolean(), nullable=False, server_default="false"),
    )
    op.add_column(
        "seasons",
        sa.Column("use_paper_scoring", sa.Boolean(), nullable=False, server_default="false"),
    )
    op.add_column(
        "seasons",
        sa.Column(
            "use_documentation_scoring", sa.Boolean(), nullable=False, server_default="false"
        ),
    )
    op.add_column(
        "seasons", sa.Column("use_aerial", sa.Boolean(), nullable=False, server_default="false")
    )
    # JSON list of active team categories: ["botball", "open", "aerial", "jbc"]
    op.add_column(
        "seasons",
        sa.Column("active_categories", sa.JSON(), nullable=False, server_default='["botball"]'),
    )
